...
class AlternateRowBackgroundJTablePanel : AbstractGridBagJPanel() {
    ...
    private val tableModel = DefaultTableModel(0, 2).also {
        val random = Random()
        repeat(10) { i ->
    ...
    companion object {
        private const val serialVersionUID: Long = -5141396331324550829L
    }
